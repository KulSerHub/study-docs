...
- **Node.js 20.19+** (вместе с ним ставится `npm`) — для запуска скрипта очистки и установки зависимостей. <br>
...
Откройте терминал в **корне вашего проекта** и выполните команды — первая склонирует репозиторий в `.claude/skills/study-docs` (папка создастся автоматически), вторая установит зависимости:
